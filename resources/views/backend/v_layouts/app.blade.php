...
<head>
    ...
    <title>Dashboard Hotel Bookingin</title>
    <!-- Custom CSS -->
                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="">
                        ...
                        <b class="logo-icon p-l-10">
                            <!-- Ubah margin-bottom di sini -->
                            <img src="{{ asset('backend/images/logo-putih.png') }}" alt="homepage" class="light-logo"
                                style="max-width: 100%" />
                        </b>
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="{{ asset('backend/images/logo-nav-text.png') }}" alt="homepage"
                                class="light-logo" />
